...
contract dBank {
  ...
  //add events
  event Deposit(address indexed user, uint256 etherAmount, uint timeStart);
  event Withdraw(address indexed user, uint256 etherAmount, uint depositTime, uint256 interest);
  ...
  function withdraw() public {
    ...
    //31668017 - interest(10% APY-Annual Percentage Yield) per second for min. deposit amount(0.01 ETH), cuz:
    ...
    //for deposit 0.02 ETH, (etherBalanceOf[msg.sender] / 1e16) = 2 (double, (2*31668017)/s)
  ...
  function borrow() payable public {
    ...
    uint256 tokenToMint = collateralEther[msg.sender] / 2;
