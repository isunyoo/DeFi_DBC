        ...
        return ( 
            <div className = 'text-monospace'>
                ...
                <div className="container-fluid mt-5 text-center">                    
                    <br></br>       
                    <h1> { /*add welcome msg*/ } Welcome to Decentralized Bank </h1>
                    <h2> { /*add user address*/ } { this.state.account } </h2>                    
                    <br></br>                           
                    <div className="row">
                                ...
                                <Tab eventKey="borrow" title="Borrow">
                                    <div>
                                        ...
                                        <form onSubmit={(e) => {
                                            ...
                                            <div className='form-group mr-sm-2'>
                                                <input id='borrowAmount' step='0.01' type='number' ref={(input) => {this.borrowAmount=input}} className='form-control form-control-md' placeholder='amount...' required />
                                            </div>
